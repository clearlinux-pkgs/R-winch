...
Version  : 0.0.8
Release  : 17
URL      : https://cran.r-project.org/src/contrib/winch_0.0.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/winch_0.0.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647532014
